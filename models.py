...
class DetectionResult:
    ...
    def __post_init__(self):
        ...
        if self.tag_family == "36h11":
            ...
            from image_service import sort_detections_clockwise
            ...
            # Filter out detections with tag_id outside valid range [1, required_detections]
            valid_detections = [d for d in self.detections if 0 < d.tag_id < required_detections+1]
